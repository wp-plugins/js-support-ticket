...
<span class="js-admin-title"><?php echo __('ADD_PRIORITY','js-support-ticket'); ?></span>
<form method="post" action="<?php echo admin_url("?page=priority&task=savepriority"); ?>">
		...
		<div class="js-form-wrapper">
			<div class="js-form-title"><?php echo __('PRIORITY_COLOR','js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
	...
	<div class="js-form-button">
		<?php echo JSSTformfield::submitbutton('save',__('SAVE_PRIORITY','js-support-ticket'),array('class'=>'button')); ?>
	</div>	
</form>
<script type="text/javascript">
	jQuery(document).ready(function(){
