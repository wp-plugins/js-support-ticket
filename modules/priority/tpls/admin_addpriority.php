...
<span class="js-admin-title"><?php echo __('Add Priority', 'js-support-ticket'); ?></span>
<form method="post" action="<?php echo admin_url("?page=priority&task=savepriority"); ?>">
    ...
    <div class="js-form-wrapper">
        <div class="js-form-title"><?php echo __('Priority Color', 'js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
    ...
    <div class="js-form-wrapper">
        <div class="js-form-title"><?php echo __('Is Public', 'js-support-ticket'); ?></div>
    ...
    <div class="js-form-wrapper">
        <div class="js-form-title"><?php echo __('Is Default', 'js-support-ticket'); ?></div>
        <div class="js-form-field"><?php echo JSSTformfield::radiobutton('isdefault', array('1' => __('Yes', 'js-support-ticket'), '0' => __('No', 'js-support-ticket')), isset(jssupportticket::$_data[0]->isdefault) ? jssupportticket::$_data[0]->isdefault : '1', array('class' => 'radiobutton')); ?></div>
    </div>
    <div class="js-form-wrapper">
        <div class="js-form-title"><?php echo __('Status', 'js-support-ticket'); ?></div>
        <div class="js-form-field"><?php echo JSSTformfield::radiobutton('status', array('1' => __('Approved', 'js-support-ticket'), '0' => __('Not Approved', 'js-support-ticket')), isset(jssupportticket::$_data[0]->status) ? jssupportticket::$_data[0]->status : '1', array('class' => 'radiobutton')); ?></div>
    </div>
