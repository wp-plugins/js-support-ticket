...
<h1 class="js-ticket-heading"><?php echo jssupportticket::$_config['title']; ?></h1>
    ...
    <a class="js-col-xs-12 js-col-sm-6 js-col-md-4 js-ticket-frontend-manu" href="<?php echo site_url("?page_id=" . jssupportticket::$_pageid . "&module=ticket&layout=addticket"); ?>">
        <span class="js-ticket-frontend-manu-text"><?php echo __('OPEN_TICKET', 'js-support-ticket'); ?></span>
    ...
    <a class="js-col-xs-12 js-col-sm-6 js-col-md-4 js-ticket-frontend-manu" href="<?php echo site_url("?page_id=" . jssupportticket::$_pageid . "&module=ticket&layout=myticket"); ?>">
        <span class="js-ticket-frontend-manu-text"><?php echo __('MY_TICKETS', 'js-support-ticket'); ?></span>
        <div class="js-ticket-frontend-manu-circle">            
