...
<div class="js-row js-pro-feature-wrapper">
    ...
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-title"><?php echo __('Field Ordering', 'js-support-ticket'); ?></span>
        <span class="js-pro-feature-description"><?php echo __('Field ordering let you change the order of the ticket fields', 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-description"><?php echo __("Internal mail system for communication within staff's and administrator", 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
    ...
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-description"><?php echo __('Help topic can be add with respect to departements', 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
    ...
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-title"><?php echo __("FAQ's", 'js-support-ticket'); ?></span>
        <span class="js-pro-feature-description"><?php echo __("You can manage FAQ's", 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-description"><?php echo __('You can ban and unban any spammy email address', 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
    ...
    <div class="js-col-md-6 js-pro-feature">
        ...
        <span class="js-pro-feature-description"><?php echo __('Internal note for staff members and administrator ticket based', 'js-support-ticket'); ?></span>
    </div>
    <div class="js-col-md-6 js-pro-feature">
        <img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/pro_page/stafftransfer.png" class="js-stafftransfer"/>
        <span class="js-pro-feature-title"><?php echo __('Staff Transfer', 'js-support-ticket'); ?></span>
