...
<div class="js-wrapper">
    ...
    <div class="js-box-wrapper js-2">
        ...
        <a class="js-admin-link" href="?page=fieldordering&layout=fieldordering"><div class="js-box"><div class="img-wrapper"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/fieldordering.png"/></div><div class="text-wrapper"><?php echo __('Fields ordering', 'js-support-ticket'); ?></div></div></a>
    </div>
    ...
    <?php foreach (jssupportticket::$_data['tickets'] AS $ticket): ?>
        <div class="js-ticket-admin-cp-data">
            <div class="js-col-xs-12 js-col-md-2"><span class="js-ticket-admin-cp-showhide"><?php
                    ...
                    echo " : ";
                    ?></span> <a href="<?php echo admin_url("admin.php?page=ticket&layout=ticketdetail&jssupportticketid=" . $ticket->id); ?>"><?php echo $ticket->ticketid; ?></a></div>
