...
<div class="js-col-md-12" style = "margin-bottom:10px;margin-top:10px;">
    ...
    <div class="js-col-md-2 js-myticket-link">
        <a class="js-myticket-link <?php echo $alltickets; ?>" href="<?php echo admin_url("admin.php?page=ticket&layout=tickets&list=5"); ?>" ><?php echo __('All Tickets', 'js-support-ticket'); ?></a>
    </div>
</div>
