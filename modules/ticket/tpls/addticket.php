...
<script type="text/javascript">
	jQuery(document).ready(function($) {
		...
		function get_tinymce_content(){
		    if (jQuery("#message").hasClass("tmce-active")){
...
<form class="js-ticket-form" method="post" action="<?php echo site_url("?page_id=".jssupportticket::$_pageid."&task=ticket_saveticket"); ?>" id="adminTicketform" enctype="multipart/form-data">
	...
	<div class="js-formwrapper-12">
		<div class="js-col-md-6 js-form-wrapper">
			...
			<div class="js-col-md-12 js-form-value"><?php echo formfield::text('phone',isset(jssupportticket::$_data[0]->phone) ? jssupportticket::$_data[0]->phone : '',array('class'=>'inputbox')) ?></div>
		</div>
		<div class="js-col-md-6 js-form-wrapper">
			<div class="js-col-md-12 js-form-title"><?php echo __('PHONE_EXT','js-support-ticket'); ?></div>
			<div class="js-col-md-12 js-form-value"><?php echo formfield::text('phoneext',isset(jssupportticket::$_data[0]->phoneext) ? jssupportticket::$_data[0]->phoneext : '',array('class'=>'inputbox')) ?></div>
		</div>
	</div>
	<div class="js-formwrapper-12">
		<div class="js-col-md-6 js-form-wrapper">
			<div class="js-col-md-12 js-form-title"><?php echo __('DEPARTMENT','js-support-ticket'); ?></div>
			<div class="js-col-md-12 js-form-value"><?php echo formfield::select('departmentid',includer::getJSModel('department')->getDepartmentForCombobox(),isset(jssupportticket::$_data[0]->departmentid) ? jssupportticket::$_data[0]->departmentid : '',__('SELECT_DEPARTEMNT','js-support-ticket'),array('class'=>'inputbox','data-validation'=>"required"));?></div>
		</div>
		<div class="js-col-md-6 js-form-wrapper">
			<div class="js-col-md-12 js-form-title"><?php echo __('PRIORITY','js-support-ticket'); ?></div>
			<div class="js-col-md-12 js-form-value"><?php echo formfield::select('priorityid',includer::getJSModel('priority')->getPriorityForCombobox(),isset(jssupportticket::$_data[0]->priorityid) ? jssupportticket::$_data[0]->priorityid : includer::getJSModel('priority')->getDefaultPriorityId(),__('SELECT_PRIORITY','js-support-ticket'),array('class'=>'inputbox','data-validation'=>"required"));?></div>
		</div>
	</div>	
	<div class="js-col-md-12 js-form-wrapper">
		...
		<div class="js-col-md-12 js-form-value"><?php echo formfield::text('subject',isset(jssupportticket::$_data[0]->subject) ? jssupportticket::$_data[0]->subject : '',array('class'=>'inputbox','data-validation'=>'required')) ?></div>
	</div>
	...
	<div class="js-col-md-12">
		<div class="js-col-md-12"><?php echo __('ATTACHMENTS','js-support-ticket'); ?></div>
		<div class="js-col-md-12">
	...
	<?php /*
	<div class="js-col-md-6 js-form-wrapper">
		<div class="js-col-md-12 js-form-title"><?php echo __('DUE_DATE','js-support-ticket'); ?></div>
		<div class="js-col-md-12 js-form-value"><?php echo formfield::text('duedate',jssupportticket::$_data[0]->duedate,array('class'=>'custom_date')); ?></div>
	</div>
	*/ ?>
<?php
$i = 0;
 foreach( jssupportticket::$_data[3] as $ufield){ 
            ...
            echo '	</div>
            		<div class="js-col-md-12 js-form-value">';
	                    $readonly = ($userfield->readonly == 1) ? ' readonly="readonly"' : '';
	                    $maxlength = ($userfield->maxlength > 0) ? 'maxlength="'.$userfield->maxlength.'"' : '';
	...
	<div class="js-form-button">
		<?php echo formfield::submitbutton('save',__('SAVE_TICKET','js-support-ticket'),array('class'=>'button','onClick'=>'return checkVal();')); ?>
	</div>
</form>
