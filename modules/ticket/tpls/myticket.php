...
if (jssupportticket::$_config['offline'] == 2) {
    if (get_current_user_id() != 0) {
        ...
        <div class="js-row">
            <div class="js-col-xs-12 js-col-md-2 js-col-md-offset-2 js-myticket-link">
                <a class="js-myticket-link <?php echo $open; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&module=ticket&layout=myticket&list=1"); ?>" ><?php echo __('Open', 'js-support-ticket'); ?></a>
            </div>
            <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                <a class="js-myticket-link <?php echo $answered; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&module=ticket&layout=myticket&list=2"); ?>" ><?php echo __('Closed', 'js-support-ticket'); ?></a>
            </div>
            <div class="js-col-xs-12 js-col-md-2 js-myticket-link">
                <a class="js-myticket-link <?php echo $myticket; ?>" href="<?php echo site_url("?page_id=" . jssupportticket::getPageid() . "&module=ticket&layout=myticket&list=4"); ?>" ><?php echo __('My Tickets', 'js-support-ticket'); ?></a>
            </div>
        </div>
