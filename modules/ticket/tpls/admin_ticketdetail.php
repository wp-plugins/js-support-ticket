            ...
            <div id="js-hidden-ticket-data">
                ...
                <div class="js-row">
                    <div class="js-col-md-4 js-ticket-moredetail">
                        ...
                        <div class="js-col-md-6 js-ticket-data-value"><?php if(!empty(jssupportticket::$_data[0]->phone)) echo jssupportticket::$_data[0]->phone; else echo __("Not Filled",'js-support-ticket'); ?></div>
                    </div>
                    <?php
