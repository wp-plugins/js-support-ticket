                        ...
                        <div class="js-form-wrapper">
                            ...
                            <div class="js-form-value">
                                <?php if (isset(jssupportticket::$_data[0]->uid)) { ?>
                                    <input type="text" id="username-text" name="username-text" value="<?php if(isset($formdata['username-text'])) echo $formdata['username-text']; else echo jssupportticket::$_data[0]->user_login;?>" readonly="readonly" <?php if($field->required == 1) echo 'data-validation="required"'; ?>/><div id="username-div"></div>
                                    <?php } else {
                                    ?>
