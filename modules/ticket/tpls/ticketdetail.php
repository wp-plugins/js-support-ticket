        ...
        <?php
            if(!empty(jssupportticket::$_data[0])){
                ...
                $cur_uid = get_current_user_id();
                    $link = site_url("?page_id=".jssupportticket::$_pageid."&module=reply&task=savereply");
                ?>	
                ...
                <form method="post" action="<?php echo $link; ?>" id="adminTicketform" enctype="multipart/form-data">
                    ...
                    <div class="js-row js-ticket-topbar">
                      ...
                      <div class="js-col-xs-12 js-col-md-4 js-mid-ticketdetail-part">
                        <div class="js-row js-margin-bottom">
                          <div class="js-col-xs-5 js-col-md-6 js-ticket-title"><?php echo __('TICKET_ID','js-support-ticket'); ?></div>
                        ...
                        <div class="js-row">
                          ...
                          <div class="js-col-xs-6 js-col-md-5 js-ticket-value js-ticket-wrapper-textcolor" style="color:#FFFFFF; background:<?php echo jssupportticket::$_data[0]->prioritycolour; ?>;"><?php echo jssupportticket::$_data[0]->priority; ?></div>
                        </div>
                      </div>
                      <div class="js-col-xs-12 js-col-md-3 js-last-left">
                        <div class="js-row">
                          <div class="js-col-xs-5 js-col-md-6 js-ticket-title"><?php echo __('LAST_REPLY','js-support-ticket'); ?></div>
                          <div class="js-col-xs-6 js-col-md-5 js-ticket-value"><?php if(empty(jssupportticket::$_data[0]->lastreply)|| jssupportticket::$_data[0]->lastreply == '0000-00-00 00:00:00') echo __('NO_LAST_REPLY','js-support-ticket'); else echo date(jssupportticket::$_config['date_format'],strtotime(jssupportticket::$_data[0]->lastreply)); ?></div>
                        </div>
                        <div class="js-row">
                    ...
                    <div class="js-row js-ticket-middlebar">
                      ...
                      <div class="js-col-xs-12 js-col-md-3 js-button-margin">
                              <?php if(jssupportticket::$_data[0]->status != 4){ ?>
                                      <a style="height:36px" onclick="return confirm('<?php echo __('ARE_YOU_SURE_TO_CLOSE_TICKET','js-support-ticket'); ?>');" class="button" href="<?php echo site_url("?page_id=".jssupportticket::$_pageid."&module=ticket&task=closeticket&action=jstask&ticketid=".jssupportticket::$_data[0]->id); ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/remove.png" title="<?php echo __('DELETE_TICKET','js-support-ticket'); ?>" /><?php echo __('CLOSE_TICKET','js-support-ticket'); ?></a>
                                      &nbsp;
                                <?php }else{ 
                                    if(JSSTincluder::getJSModel('ticket')->checkCanReopenTicket(jssupportticket::$_data[0]->id)){
                                    $link = site_url("?page_id=".jssupportticket::$_pageid."&module=ticket&action=jstask&task=reopenticket&ticketid=".jssupportticket::$_data[0]->id);
                                    ?>
                                          <a class="button" href="<?php echo $link; ?>" alt="<?php echo __('REOPEN_TICKET','js-support-ticket'); ?>"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/reopen.png" title="<?php echo __('REOPEN_TICKET','js-support-ticket'); ?>" /></a>
                  ...
                  <div class="js-col-md-12 js-ticket-detail-wrapper">
                        ...
                        <div class="js-row">
                          ...
                          <?php
                            foreach(jssupportticket::$_data[2] as $ufield){
                              echo '<div class="js-col-md-6 js-ticket-moredetail">';
                              $userfeild = $ufield[0];
                   ...
                   <?php 
                      $colored = "colored";
                      ?>
                  <div class="js-col-xs-12 js-col-md-12 js-ticket-suheading"><?php echo __('TICKET_THREAD','js-support-ticket'); ?></div>
                  ...
                  <?php echo JSSTformfield::hidden('form_request','jssupportticket'); ?>
                    ...
                    <div class="js-col-xs-12 js-col-md-12 js-ticket-suheading">
                      <?php echo __('POST_REPLY','js-support-ticket'); ?>
                    </div>
                    <form class="js-col-xs-12 js-col-md-12 post-reply-textarea"  method="post" action="<?php echo site_url("?page_id=".jssupportticket::$_pageid."&module=reply&task=savereply"); ?>" enctype="multipart/form-data">
                          <div class="js-form-wrapper">
                            <div class="js-col-xs-12 js-col-md-12"><?php echo wp_editor('','message',array( 'media_buttons' => false ));?></div>
                                        ...
                                        <div class="js-col-xs-12 js-form-field">
                                            ...
                                            <div><span id="tk_attachment_add" class="tk_attachments_addform"><?php echo __('ADD_MORE_FILE', 'js-support-ticket'); ?></span></div>
                                            <span class="fileLimits">
                                                <small class"js-col-xs-12"><?php echo __('MAXIMUM_FILE_SIZE', 'js-support-ticket');
                          ...
                          <div class="js-col-xs-12 js-col-md-12 js-form-wrapper">
                                        ...
                                        <div class="js-col-xs-12 js-col-md-6 replyFormStatus"><?php echo JSSTformfield::checkbox('closeonreply', array('1' => __('CLOSE_ON_REPLY', 'js-support-ticket')), '', array('class' => 'radiobutton')); ?></div>
                                    </div>
