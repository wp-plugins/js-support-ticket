...
class JSSTemailtemplateModel{
	...
	function storeEmailTemplate($data){
		...
		if(jssupportticket::$_db->last_error  == null){
			JSSTmessage::setMessage(__('EMAIL_TEMPLATE_HAS_BEEN_STORED','js-support-ticket'),'updated');
		}else{
			JSSTincluder::getJSModel('systemerror')->addSystemError();// if there is an error add it to system errorrs
			JSSTmessage::setMessage(__('EMAIL_TEMPLATE_HAS_NOT_BEEN_STORED','js-support-ticket'),'error');
		}
		return;
	}
}
