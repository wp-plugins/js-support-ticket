...
class JSSTuserfeildModel {
    ...
    function storeUserFeild($data) {
        ...
        if (jssupportticket::$_db->last_error != null) {
            JSSTincluder::getJSModel('systemerror')->addSystemError();
            JSSTmessage::setMessage(__('USER_FIELD_HAS_NOT_BEEN_STORED', 'js-support-ticket'), 'error');
        } else {
            JSSTmessage::setMessage(__('USER_FIELD_HAS_BEEN_STORED', 'js-support-ticket'), 'updated');
    ...
    function removeUserFeild($id) {
        ...
        if ($this->canRemoveUserFeild($id)) {
            ...
            if (jssupportticket::$_db->last_error == null) {
                JSSTmessage::setMessage(__('USER_FIELD_HAS_BEEN_DELETED', 'js-support-ticket'), 'updated');
            } else {
                JSSTincluder::getJSModel('systemerror')->addSystemError(); // if there is an error add it to system errorrs
                JSSTmessage::setMessage(__('USER_FIELD_HAS_NOT_BEEN_DELETED', 'js-support-ticket'), 'error');
            }
        } else {
            JSSTmessage::setMessage(__('USER_FIELD_IN_USE_CANNOT_DELETED', 'js-support-ticket'), 'error');
        }
        return;
    }
