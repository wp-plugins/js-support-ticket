    ...
    <div class="js-filter-form-list">
        ...
        foreach (jssupportticket::$_data[0] AS $userfeild) {
            ...
            <div class="js-filter-form-data">
                <div class="js-col-md-3 js-col-xs-12 first"><span class="js-filter-form-data-xs"><?php
                        echo __('Field Name', 'js-support-ticket');
                        echo " : ";
                        ?></span><a href="?page=userfeild&layout=adduserfeild&jssupportticketid=<?php echo $userfeild->id; ?>"><?php echo $userfeild->name; ?></a></div>
                <div class="js-col-md-3 js-col-xs-12 second js-textaligncenter"><span class="js-filter-form-data-xs"><?php
                        echo __('Field Title', 'js-support-ticket');
                        echo " : ";
                        ?></span><?php echo $userfeild->title; ?></div>
                ...
                echo " : ";
                        ?></span> <?php echo $userfeild->type; ?></div>
                <div class="js-col-md-1 js-col-xs-12 fourth js-textaligncenter"><span class="js-filter-form-data-xs"><?php
                        echo __('Required', 'js-support-ticket');
                        echo " : ";
                        ?></span><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $required; ?>" /></div>
                <div class="js-col-md-1 js-col-xs-12 fifth js-textaligncenter"><span class="js-filter-form-data-xs"><?php
                        echo __('Read Only', 'js-support-ticket');
                        echo " : ";
                        ?></span> <img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $readonly; ?>" /></div>
                <div class="js-col-md-1 js-col-xs-12 sixth js-textaligncenter"><span class="js-filter-form-data-xs"><?php
                        echo __('Published', 'js-support-ticket');
                        echo " : ";
                        ?></span><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/<?php echo $published; ?>" /></div>
