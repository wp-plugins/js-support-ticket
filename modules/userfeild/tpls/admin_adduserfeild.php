...
<?php 
$YesOrNo = array( (object)array('id'=> '2','text'=>__('NO','js-support-ticket')),
                  (object)array('id' => '1','text'=> __('YES','js-support-ticket'))) ;
$fieldtype = array( (object)array('id'=> 'text','text'=>__('TEXT_FIELD','js-support-ticket')),
                    (object)array('id' => 'select','text'=> __('DROP_DOWN','js-support-ticket')),
                    (object)array('id' => 'email','text'=> __('EMAIL_ADDRESS','js-support-ticket')),
                    (object)array('id' => 'checkbox','text'=> __('CHECK_BOX','js-support-ticket')),
                    (object)array('id' => 'date','text'=> __('DATE','js-support-ticket')),
                    (object)array('id' => 'textarea','text'=> __('TEXT_AREA','js-support-ticket'))
                  );
                        ?>

<span class="js-admin-title"><?php echo __('ADD_USER_FIELD','js-support-ticket'); ?></span>
<form method="post" action="<?php echo admin_url("admin.php?page=userfeild&task=saveuserfeild"); ?>" id="adminForm">
		<div class="js-form-wrapper">
			<div class="js-form-title"><?php echo __('FIELD_TYPE','js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
			<div class="js-form-field"><?php echo JSSTformfield::select('type',$fieldtype,isset(jssupportticket::$_data[0][0]->type) ? jssupportticket::$_data[0][0]->type : '',__('SELECT_TYPE','js-support-ticket'),array('class'=>'inputbox','onchange'=>'toggleType(this.options[this.selectedIndex].value);','data-validation'=>'required'));?></td>
		</div>
		<div class="js-form-wrapper">
			<div class="js-form-title"><?php echo __('FIELD_NAME','js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
		...
		<div class="js-form-wrapper">
			<div class="js-form-title"><?php echo __('FIELD_TITLE','js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
		...
		<div class="js-form-wrapper">
			...
			<div class="js-form-field"><?php echo JSSTformfield::select('required',$YesOrNo,isset(jssupportticket::$_data[0][0]->required ) ? jssupportticket::$_data[0][0]->required : '','',array('class'=>'inputbox'));?></div>
		</div>
		<div class="js-form-wrapper">
			<div class="js-form-title"><?php echo __('READ_ONLY','js-support-ticket'); ?></div>
			<div class="js-form-field"><?php echo JSSTformfield::select('readonly',$YesOrNo,isset(jssupportticket::$_data[0][0]->readonly ) ? jssupportticket::$_data[0][0]->readonly : '','',array('class'=>'inputbox'));?></div>
		</div>
		<div class="js-form-wrapper">
      <div class="js-form-title"><?php echo __('PUBLISHED','js-support-ticket'); ?></div>
      <div class="js-form-field"><?php echo JSSTformfield::select('published',$YesOrNo,isset(jssupportticket::$_data[0][0]->published ) ? jssupportticket::$_data[0][0]->published : '','',array('class'=>'inputbox'));?></div>
    </div>
		<div class="js-form-wrapper">
		...
		<div id="page1"></div>
			<div id="divText">
				<div class="js-form-wrapper">
					...
					<div class="js-form-field"><?php echo JSSTformfield::text('maxlength',isset(jssupportticket::$_data[0][0]->maxlength ) ? jssupportticket::$_data[0][0]->maxlength : '',array('class'=>'inputbox')); ?></div>
				</div>
			</div>
			<div id="divColsRows">
				<div class="js-form-wrapper">
          ...
          <div class="js-form-button">
            <?php echo JSSTformfield::submitbutton('save',__('SAVE_USER_FIELD','js-support-ticket'),array('class'=>'button')); ?>
          </div>
			</form>
