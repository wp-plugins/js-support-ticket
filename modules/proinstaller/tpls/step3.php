<div id="jsst-main-wrapper" >
    ...
    <div id="jsst-lower-wrapper" class="last">
        <span class="fill_form_title"><?php echo __('PLEASE_INSERT_ACTIVATION_KEY_AND_PRESS_START','js-support-ticket');?></span>
        <div class="form">
            <input type="text" name="transactionkey" id="transactionkey" value="" placeholder="<?php echo __('ACTIVATION_KEY','js-support-ticket'); ?>"/>
    ...
    <div class="last-message">
        <?php echo __('IT_MAY_TAKE_FEW_MINUTES','js-support-ticket'); ?>
    </div>
</div>
