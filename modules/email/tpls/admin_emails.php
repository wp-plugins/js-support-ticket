...
<a class="js-add-link button" href="?page=email&layout=addemail"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Email', 'js-support-ticket'); ?></a>
<?php if (!empty(jssupportticket::$_data[0])) { ?>  		
    <div class="js-filter-form-list">
        ...
        echo " : "; ?></span><a href="?page=email&layout=addemail&jssupportticketid=<?php echo $email->id; ?>"><?php echo $email->email; ?></a></div>
        ...
        echo " : "; ?></span><?php echo date(jssupportticket::$_config['date_format'], strtotime($email->created)); ?></div>
