...
<a class="js-add-link button" href="?page=department&layout=adddepartment"><img src="<?php echo jssupportticket::$_pluginpath; ?>includes/images/add_icon.png" /><?php echo __('Add Department', 'js-support-ticket') ?></a>
<?php if (!empty(jssupportticket::$_data[0])) { ?>  		
    <div class="js-filter-form-list">
        ...
        echo " : "; ?></span><a href="?page=department&layout=adddepartment&jssupportticketid=<?php echo $department->id; ?>"><?php echo __($department->departmentname, 'js-support-ticket'); ?></a></div>
                <div class="js-col-xs-12 js-col-md-2 second"><span class="js-filter-form-data-xs"><?php echo __('Outgoing Email', 'js-support-ticket');
        ...
        echo " : "; ?></span><?php echo date(jssupportticket::$_config['date_format'], strtotime($department->created)); ?></div>
