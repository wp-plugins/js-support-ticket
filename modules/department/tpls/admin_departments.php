        ...
        foreach (jssupportticket::$_data[0] AS $department) {
            ...
            <div class="js-filter-form-data">
                <div class="js-col-xs-12 js-col-md-3 first"><span class="js-filter-form-data-xs"><?php
                        ...
                        echo " : ";
                        ?></span><a href="?page=department&layout=adddepartment&jssupportticketid=<?php echo $department->id; ?>"><?php echo __($department->departmentname, 'js-support-ticket'); ?></a></div>
