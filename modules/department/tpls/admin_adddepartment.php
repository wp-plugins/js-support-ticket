...
<span class="js-admin-title"><?php echo __('ADD_DEPARTMENT','js-support-ticket'); ?></span>
<form method="post" action="<?php echo admin_url("admin.php?page=department&task=savedepartment"); ?>">
	...
	<div class="js-form-wrapper">
		<div class="js-form-title"><?php echo __('OUT_GOING_EMAIL','js-support-ticket'); ?>&nbsp;<font color="red">*</font></div>
		<div class="js-form-field"><?php echo JSSTformfield::select('emailid',JSSTincluder::getJSModel('email')->getEmailForDepartment(),isset(jssupportticket::$_data[0]->emailid ) ? jssupportticket::$_data[0]->emailid : '',__('SELECT_EMAIL','js-support-ticket'),array('class'=>'inputbox','data-validation'=>'required'));?></div>
	</div>
	<div class="js-form-wrapper">
	...
	<div class="js-form-wrapper">
		...
		<div class="js-form-field"><?php echo JSSTformfield::checkbox('canappendsignature',array('1'=>__('APPEND_SIGNATURE_WITH_REPLY','js-support-ticket')),isset(jssupportticket::$_data[0]->canappendsignature ) ? jssupportticket::$_data[0]->canappendsignature : '1',array('class'=>'radiobutton'));?></div>
	</div>
	<div class="js-form-wrapper">
		<div class="js-form-title"><?php echo __('STATUS','js-support-ticket'); ?></div>
		<div class="js-form-field"><?php echo JSSTformfield::radiobutton('status',array('1'=>__('APPROVED','js-support-ticket'),'0'=>__('NOT_APPROVED','js-support-ticket')),isset(jssupportticket::$_data[0]->status ) ? jssupportticket::$_data[0]->status : '1',array('class'=>'radiobutton'));?></div>
	</div>
	...
	<div class="js-form-button">
		<?php echo JSSTformfield::submitbutton('save',__('SAVE_DEPARTMENT','js-support-ticket'),array('class'=>'button')); ?>
	</div>
</form>
